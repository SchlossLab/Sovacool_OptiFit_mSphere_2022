...
sequence in an OTU, thus resulting in some dissimilar sequences being assigned
to the same OTU.
...
Like OptiFit, OptiClust considers the similarity of all pairs of reference and
