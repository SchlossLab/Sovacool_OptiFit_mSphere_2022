...
- 16S rRNA gene sequence datasets from human gut, mouse gut, marine, and soil environments were processed with mothur and clustered _de novo_ with mothur's OptiClust algorithm.
...
- Public reference databases (greengenes, silva, and RDP) were clustered _de novo_ using OptiClust, then query datasets were fit to the _de novo_ OTUs using OptiFit.
  - In open-reference mode, OTU quality was similar between fitting the datasets to reference OTUs with OptiFit and clustering the datasets _de novo_ with OptiClust. 
