...
- **TODO: toy example like opticlust with figure**.
...
**TODO: more narrative, less documentation-like.**
**TODO: extension of opticlust except ref otus are fixed. just like opticlust only query seqs can move otus.**
...
in its current OTU, moves to each of the other OTUs, or is discarded.
...
- order of importance: mcc, mapping, sec

**TODO: lead with comparison of optifit vs current state of the art. give context at beginning.**
We performed _de novo_ clustering with OptiClust at distance threshold of 3% (TODO R CODE HERE)
...
TODO: pick a fraction (e.g. 50%). this comparison would be supplemental if there's a figure.
