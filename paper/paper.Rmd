...
- Datasets were randomly split into a reference fraction and a query fraction.
  ...
  - Reference sizes from 10% to 80% of the sequences were created, with the remaining sequences used for the query.
  ...
  - Different methods for selecting the sequences to be used as the reference were tested; simple random sample, weighting sequences by relative abundance, and weighting by similarity to other sequences in the dataset.
