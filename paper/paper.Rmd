...
previously [@westcott_opticlust_2017].
...
produced OTUs of similar quality as clustering the datasets _de novo_ with
OptiClust (**diff. in medians**).
This held true for all datasets and reference databases.
...
16S sequences compared to about 170,000 in SILVA and Greengenes (**TODO: insert
R code to generate these numbers**).
...
We have developed a new reference-based clustering algorithm that allows users
to produce high quality OTUs when stability is a requirement for the task at hand.
...
**TODO: describe split dataset creation**
