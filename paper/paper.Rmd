...
Additionally, the greedy clustering algorithms implemented in VSEARCH are
sensitive to the order of the input sequences: different OTU assignments are
produced when the same sequences are randomly shuffled [@westcott_novo_2015;
@he_stability_2015].
