...
region of each sequence (see Figure ). After trimming to the V4 region,
...
the median MCC was 0.35 when clustering to RDP (Figure ; “db:
...
sequences than OptiFit to the Greengenes reference database (Figure ).
