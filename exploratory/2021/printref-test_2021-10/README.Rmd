...
With `printref=f` the reference sequences are not included in the final MCC
score, which makes sense when fitting to an independent database like
greengenes. but **for the split dataset strategy, wouldn't it make more sense to
include ref seqs in the MCC to be a more comparable comparison to de novo?**
