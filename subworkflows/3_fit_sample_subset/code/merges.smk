...
rule merge_sensspec2:
    ...
    input:
        code='../../code/R/merge_results.R',
        fcns='../../code/R/functions.R',
        tsv=[f'results/{dataset}/refweight_{ref_weight}/reffrac_{ref_frac}/samplefrac_{sample_frac}/seed_{seed}/fit/method_{method}/printref_{printref}/{dataset}.pick.optifit_mcc.mod.sensspec' for ref_frac, sample_frac in zip(ref_fracs, sample_fracs_complement) for dataset in datasets for ref_weight in random_refweight_options for seed in seeds for method in methods for printref in printrefs]
    output:
...
rule merge_benchmarks2:
    ...
    input:
        code='../../code/R/merge_results.R',
        fcns='../../code/R/functions.R',
        tsv=[f'benchmarks/{dataset}/fit.method_{method}.printref_{printref}.refweight_{ref_weight}.reffrac_{ref_frac}.samplefrac_{sample_frac}.seed_{seed}.mod.txt' for ref_frac, sample_frac in zip(ref_fracs, sample_fracs_complement) for dataset in datasets for ref_weight in random_refweight_options for seed in seeds for method in methods for printref in printrefs]
    output:
...
rule merge_fractions2:
    ...
    input:
        code='../../code/R/merge_results.R',
        fcns='../../code/R/functions.R',
        tsv=[f'results/{dataset}/refweight_{ref_weight}/reffrac_{ref_frac}/samplefrac_{sample_frac}/seed_{seed}/fit/method_closed/printref_{printref}/fraction_reads_mapped.txt' for ref_frac, sample_frac in zip(ref_fracs, sample_fracs_complement) for dataset in datasets for ref_weight in random_refweight_options for seed in seeds for printref in printrefs]
    output:
...
rule merge_sizes2:
    input:
        code='../../code/R/merge_results.R',
        fcns='../../code/R/functions.R',
        tsv=[f"results/{dataset}/refweight_{ref_weight}/reffrac_{ref_frac}/samplefrac_{sample_frac}/seed_{seed}/input_size.tsv" for ref_frac, sample_frac in zip(ref_fracs, sample_fracs_complement) for dataset in datasets for ref_weight in random_refweight_options for seed in seeds for method in methods for printref in printrefs]
    output:
...
rule merge_all_inputs:
    input:
        ...
        expand('results/{dataset}/refweight_{ref_weight}/reffrac_{ref_frac}/samplefrac_{sample_frac}/seed_{seed}/fit/method_{method}/printref_{printref}/{dataset}.pick.optifit_mcc.summary',
            dataset=datasets, ref_weight=random_refweight_options, ref_frac=ref_fracs, sample_frac=sample_frac_fixed, seed=seeds, method=methods, printref=printrefs),
        [f'results/{dataset}/refweight_{ref_weight}/reffrac_{ref_frac}/samplefrac_{sample_frac}/seed_{seed}/fit/method_{method}/printref_{printref}/{dataset}.pick.optifit_mcc.mod.sensspec' for ref_frac, sample_frac in zip(ref_fracs, sample_fracs_complement) for dataset in datasets for ref_weight in random_refweight_options for seed in seeds for method in methods for printref in printrefs],
        [f'benchmarks/{dataset}/fit.method_{method}.printref_{printref}.refweight_{ref_weight}.reffrac_{ref_frac}.samplefrac_{sample_frac}.seed_{seed}.mod.txt' for ref_frac, sample_frac in zip(ref_fracs, sample_fracs_complement) for dataset in datasets for ref_weight in random_refweight_options for seed in seeds for method in methods for printref in printrefs],
        [f'results/{dataset}/refweight_{ref_weight}/reffrac_{ref_frac}/samplefrac_{sample_frac}/seed_{seed}/fit/method_closed/printref_{printref}/fraction_reads_mapped.txt' for ref_frac, sample_frac in zip(ref_fracs, sample_fracs_complement) for dataset in datasets for ref_weight in random_refweight_options for seed in seeds for printref in printrefs],
        [f"results/{dataset}/refweight_{ref_weight}/reffrac_{ref_frac}/samplefrac_{sample_frac}/seed_{seed}/input_size.tsv" for ref_frac, sample_frac in zip(ref_fracs, sample_fracs_complement) for dataset in datasets for ref_weight in random_refweight_options for seed in seeds for method in methods for printref in printrefs],
